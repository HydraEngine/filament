...
public:
    ...
    filament::backend::DescriptorSetHandle createDescriptorSet(filament::backend::DriverApi& api) const;
...
void Shader::bindUniform(filament::backend::DriverApi& api, filament::backend::Handle<filament::backend::HwBufferObject> hwBuffer, UniformBindingConfig config) const {
    ...
    api.updateDescriptorSetBuffer(descriptorSet, resolvedConfig.binding, hwBuffer, 0, resolvedConfig.bufferSize);
